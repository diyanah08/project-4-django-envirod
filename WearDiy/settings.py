"""
Django settings for WearDiy project.
...
SECRET_KEY = '(1es%6&k&s(0j^jko0p)acg-r3d&2y&p=^4uka8+f!227z30%z'
...
WSGI_APPLICATION = 'WearDiy.wsgi.application'
